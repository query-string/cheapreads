  ...
  def change
    Book.all.each do |b|
      if b.average_ratings.any?
        ...
        previous_average_rating =  if b.average_ratings.size > 2 && b.average_rating == last_average_rating
      ...
      if b.amazon_paper_prices.any?
        ...
        previous_amazon_paper_price =  if b.amazon_paper_prices.size > 2 && b.amazon_paper_price == last_amazon_paper_price
      ...
      if b.amazon_kindle_prices.any?
        ...
        previous_amazon_kindle_price =  if b.amazon_kindle_prices.size > 2 && b.amazon_kindle_price == last_amazon_kindle_price
          b.amazon_kindle_prices[b.amazon_kindle_prices.size - 2].changed_value
        else
